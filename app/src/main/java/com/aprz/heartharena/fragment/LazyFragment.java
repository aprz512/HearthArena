...
public abstract class LazyFragment extends RxFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        finishInflateView(view, savedInstanceState);
    }
    ...
    protected abstract void configView(View root);

    protected abstract void finishInflateView(View view, Bundle savedInstanceState);
    ...
    public String getTitle() {
        if (null == fragmentTitle) {
            fragmentTitle = getDefaultFragmentTitle();
        }
