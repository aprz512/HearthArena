...
public class StatusLayoutManager {
    ...
    public interface OnStatusLayoutInitListener {
        void initEmptyView(View emptyView, Bundle savedInstanceState);

        void initErrorView(View errorView, Bundle savedInstanceState);

        void initNetWorkErrorView(View netWorkErrorView, Bundle savedInstanceState);

        void initContentView(View contentView, Bundle savedInstanceState);
    }
}
