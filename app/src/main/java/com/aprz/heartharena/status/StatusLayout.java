package com.aprz.heartharena.status;
...
public class StatusLayout extends FrameLayout {
    ...
    private void initView(View resView, int id) {
        ...
        switch (id) {
            case EMPTY:
                mInitListener.initEmptyView(resView, mStatusLayoutManager.getSavedInstanceState());
                break;
            case ERROR:
                mInitListener.initErrorView(resView, mStatusLayoutManager.getSavedInstanceState());
                break;
            case NETWORK_ERROR:
                mInitListener.initNetWorkErrorView(resView, mStatusLayoutManager.getSavedInstanceState());
                break;
            case CONTENT:
                mInitListener.initContentView(resView, mStatusLayoutManager.getSavedInstanceState());
                break;
        }
    }
    ...
    public void setInitListener(StatusLayoutManager.OnStatusLayoutInitListener initListener) {
        ...
        Log.e("StatusLayout", "setInitListener" + initListener);
    }
